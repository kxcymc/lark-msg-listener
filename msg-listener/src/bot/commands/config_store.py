...
WHITELIST: list[WhitelistField] = [
    ...
    WhitelistField("phase2.kxcymc.model", "str", "kxcymc 需求判断 CLI 模型名"),
    WhitelistField("phase2.claude.model", "str", "Claude 分析器模型名"),
    WhitelistField("phase2.claude.disallowed_tools", "str", "Claude 分析器额外禁用工具（逗号分隔）"),
    ...
    WhitelistField("phase3.dev_task.claude_code_cli.model", "str", "Claude 执行器模型名"),
    WhitelistField("phase3.dev_task.claude_code_cli.disallowed_tools", "str", "Claude 执行器额外禁用工具（逗号分隔）"),
